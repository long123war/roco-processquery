...
| lash           | 双开门                        |      |
| sliding        | 内置双推拉门                  |      |
| dumbs          | 哑口套，三边窗套 01，方形飘窗 |      |
| windowt        | 四边窗套                      |      |
| Wave           | L 型飘窗                      |      |
| glassdoor      | 通用玻璃门 02                 |      |
| generalSliding | 通用推拉门 02                 |      |
| hanging        | 通用吊趟门 01                 |      |
| dumb           | 哑口套 02，窗套 02            |      |

每次请求只能是其中一种，一次请求多种产品只会根据请求参数最后一种来响应。

- 响应参数

| 参数名              | 参数说明       | 备注 |
| ------------------- | -------------- | ---- |
| img/XXXX/XXXX/X.jpg | 服务器图片路径 |      |

```Object
[
    "/img/woodenDoor/single/1.jpg",
    "/img/woodenDoor/single/2.jpg",
    "/img/woodenDoor/single/3.jpg"
]
```
